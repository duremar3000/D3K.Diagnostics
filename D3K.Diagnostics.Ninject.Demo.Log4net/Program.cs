...
namespace D3K.Diagnostics.Ninject.Demo.Log4net
{
    class Program
    {
        ...
        {
            kernel.RegisterMethodIdentityInterceptor<Log4netLogContext>("pid", "pid");
            kernel.RegisterMethodLogInterceptor<Log4netLogListenerFactory>("log", "Debug");
